%======================================================================
%> @file +ISB_tutorial/move2D_IMU_withConstraint.m
...
%> in the 2025 ISB tutorial with constraint for speed instead of bounds
%>
...
% ======================================================================
function problem = move2D_IMU_withConstraint(model,resultfile, trackingData, initialGuess, varargin)
...
problem.addConstraint(@speedConstraint_IMU,0,0,targetspeed)
