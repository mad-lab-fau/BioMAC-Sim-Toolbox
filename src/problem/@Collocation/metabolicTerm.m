...
%> @brief Collocation function to compute metabolic cost of the muscles from states
%> @details
%> Details: Collocation::metabolicTerm()
%>
...
%======================================================================
%> @brief Function to metabolic cost of the muscles from states
%>
...
%======================================================================
function output = metabolicTerm(obj,option,X, name, epsilon,exponent)

%% check input parameter
% => Here in the metabolicTerm, it is not really worth initializing variables
