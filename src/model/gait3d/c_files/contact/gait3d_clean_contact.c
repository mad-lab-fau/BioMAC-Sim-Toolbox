...
// open the file that came from Autolev
    ...
    strcat(filename1, "contact_3d_raw.c");
...
// write the clean C file
    ...
    strcat(filename2, "contact_3d_al.c");
	if ((fid2 = fopen(filename2,"w")) == NULL) {
		printf("Could not write %s\n", filename2);
		exit(1);
	}
	fprintf(fid2,"// This file was generated by clean_contact.c and contains C code generated by Autolev\n\n");
	fprintf(fid2,"#include <math.h>\n");
	fprintf(fid2,"#include \"gait3d_contact.h\"\n");
	fprintf(fid2,"void contact_al(contactprop* contact,\n");										
	fprintf(fid2,"\tdouble fk[12], double fkdot[12], double x[NCVAR], double xdot[NCVAR],\n");			
	fprintf(fid2,"\tdouble f[NCF], double df_dfk[NCF][12], double df_dfkdot[NCF][12],\n");
	...
	fprintf(fid2,"\tdouble dx,dy,dz,dxf,dyf,dzf;\n");
	fprintf(fid2,"\tdouble xc, yc, zc, xcdot, zcdot, Fx, Fy, Fz;\n");
	fprintf(fid2,"\tdouble xf, yf, zf, xcloc, ycloc, zcloc;\n");
	fprintf(fid2,"\tdouble Fxloc, Fyloc, Fzloc, d, ddot, Fmag;\n");
	fprintf(fid2,"\tdouble dfx, dfy, dfz;\n");
	for (i=0; i<NCF; i++) {
