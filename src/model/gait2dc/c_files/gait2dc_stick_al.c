...
#include <math.h>
#include "gait2dc.h"
void gait2dc_stick_al(param_struct* par, double q[NDOF], double qd[NDOF], double qdd[NDOF],
  ...
  Stick[3][1] = q2 - par->ShankLen*z[17] - par->ThighLen*z[7];
  Stick[4][0] = q1 - par->ThighLen*z[30];
  Stick[4][1] = q2 - par->ThighLen*z[29];
  Stick[5][0] = q1 - par->ShankLen*z[40] - par->ThighLen*z[30];
  Stick[5][1] = q2 - par->ShankLen*z[39] - par->ThighLen*z[29];
