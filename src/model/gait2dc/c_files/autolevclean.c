 ...
 *
 * @file autolevclean.c
 * @brief MEX function to extract clean C source code from C file generated by Autolev programs
 * gait2dc.al and contact.al.
 *
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
	...
	printf("Cleaning Autolev output from gait2dc_dynamics.al...\n");

	// open the file that came from Autolev
	if ((fid1 = fopen("gait2dc_dynamics_al_raw.c","r")) == NULL) {
		printf("Could not open gait2dc_dynamics_al_raw.c\n");
		exit(1);
	}
	
// write the clean C file
	if ((fid2 = fopen("gait2dc_dynamics_al.c","w")) == NULL) {
		printf("Could not write gait2dc_dynamics_al.c\n");
		exit(1);
	}
