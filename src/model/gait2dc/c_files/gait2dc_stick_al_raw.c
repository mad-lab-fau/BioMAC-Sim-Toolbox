/* The name of this program is gait2dc_stick_al_raw.c */
...
double   par__ShankLen,par__ThighLen,par__TrunkCMy,q1,q2,q3,q4,q5,q6,q7,q8,q9,
  q1p,q2p,q3p,q4p,q5p,q6p,q7p,q8p,q9p;
double   Pi,DEGtoRAD,RADtoDEG,z[245],fk[42],dfk_dq[42][9],fkdot[42],dfkdot_dq[
  42][9],Stick[6][2],Encode[5];
...
for(iloop=0;  iloop<=0;  iloop++)
  {
  char fileName[256];
  if( !iloop ) strcpy(fileName, "gait2dc_stick_al_raw.in");
  else sprintf(fileName, "gait2dc_stick_al_raw.%d", iloop);
...
readf(Fptr[0],&par__ShankLen,&par__ThighLen,&par__TrunkCMy,&q1,&q2,&q3,&q4,&q5,&
  q6,&q7,&q8,&q9,&q1p,&q2p,&q3p,&q4p,&q5p,&q6p,&q7p,&q8p,&q9p,NULL);
...
puts( "\n Input is in the file gait2dc_stick_al_raw.in" );
return 0;
}
...
/* Write output to screen and to output file(s) */
  ...
  Stick[0][0] = q1 - par__TrunkCMy*z[2];
  Stick[0][1] = q2 + par__TrunkCMy*z[1];
  Stick[1][0] = q1;
  Stick[1][1] = q2;
  Stick[2][0] = q1 - par__ThighLen*z[8];
  Stick[2][1] = q2 - par__ThighLen*z[7];
  Stick[3][0] = q1 - par__ShankLen*z[18] - par__ThighLen*z[8];
  Stick[3][1] = q2 - par__ShankLen*z[20] - par__ThighLen*z[7];
  Stick[4][0] = q1 - par__ThighLen*z[56];
  Stick[4][1] = q2 - par__ThighLen*z[55];
  Stick[5][0] = q1 - par__ShankLen*z[66] - par__ThighLen*z[56];
  Stick[5][1] = q2 - par__ShankLen*z[68] - par__ThighLen*z[55];
