% This file was generated by create_alfile_gait10dof18musc on 06-Dec-2024
...
SIMPROT(pelvis, torso, 3, q10)
W_torso_ground> = W_pelvis_ground> + Ground3> * q10'
...
qd = [q1', q2', q3', q4', q5', q6', q7', q8', q9', q10']
qdd = [q1'', q2'', q3'', q4'', q5'', q6'', q7'', q8'', q9'', q10'']
dfk_dq    = ZEE(D(fk,q))
fkdot     = ZEE(DT(fk))
dfkdot_dq = ZEE(D(fkdot,q))
Encode fk, dfk_dq, fkdot, dfkdot_dq
Code Algebraic() gait10dof18musc\gait10dof18musc_FK_raw.c
