/*
	...
	Program to extract clean C source code from C file generated by Autolev program gait2d_osim.al
...
void mexFunction(int nlhs, mxArray *plhs[], int nrhs, const mxArray *prhs[]) {
    ...
    //===================================================================================================
    // gait2d_osim: Dynamics with derivatives
    //===================================================================================================
    ...
    char filename1[100];
    strcpy(filename1, "gait2d_osim");
    strcat(filename1, slash);
    strcat(filename1, "gait2d_osim_raw.c");
    ...
    char filename2[100];
    strcpy(filename2, "gait2d_osim");
    strcat(filename2, slash);
    strcat(filename2, "gait2d_osim_al.c");
	if ((fid2 = fopen(filename2,"w")) == NULL) {
		printf("Could not write %s\n", filename2);
		exit(1);
	}
	fprintf(fid2,"// This file was generated by clean_gait2d_osim.c and contains C code generated by Autolev\n\n");
	fprintf(fid2,"#include <math.h>\n");
	fprintf(fid2,"#include \"gait2d_osim_multibody.h\"\n");
	fprintf(fid2,"void gait2d_osim_al(                \n");
    ...
    //===================================================================================================
    // gait2d_osim_NoDer: Dynamics without derivatives
    //===================================================================================================

    // open the file that came from Autolev
    char filename1NoDer[100];
    strcpy(filename1NoDer, "gait2d_osim");
    strcat(filename1NoDer, slash);
    strcat(filename1NoDer, "gait2d_osim_NoDer_raw.c");
    ...
    strcpy(filename2NoDer, "gait2d_osim");
    strcat(filename2NoDer, slash);
    strcat(filename2NoDer, "gait2d_osim_NoDer_al.c");
	...
	fprintf(fid2,"#include <math.h>\n");
	fprintf(fid2,"#include \"gait2d_osim_multibody.h\"\n");
	fprintf(fid2,"void gait2d_osim_NoDer_al(                \n");
	fprintf(fid2,"    param_struct* par,             // input: model parameters\n");
	fprintf(fid2,"    double q[NDOF],                // input: gen.coords\n");
	fprintf(fid2,"    double qd[NDOF],               // input: gen.velocities\n");
	fprintf(fid2,"    double qdd[NDOF],              // input: gen.accelerations\n");
    ...
    //===================================================================================================
    // gait2d_osim_FK: Forward kinematics
    //===================================================================================================

    // open the file that came from Autolev
    char filename1FK[100];
    strcpy(filename1FK, "gait2d_osim");
    strcat(filename1FK, slash);
    strcat(filename1FK, "gait2d_osim_FK_raw.c");
    ...
    strcpy(filename2FK, "gait2d_osim");
    strcat(filename2FK, slash);
    strcat(filename2FK, "gait2d_osim_FK_al.c");
	...
	fprintf(fid2,"#include <math.h>\n");
	fprintf(fid2,"#include \"gait2d_osim_multibody.h\"\n");
	fprintf(fid2,"void gait2d_osim_FK_al(                \n");
	fprintf(fid2,"    param_struct* par,             // input: model parameters\n");
	fprintf(fid2,"    double q[NDOF],                // input: gen.coords\n");
	fprintf(fid2,"    double qd[NDOF],               // input: gen.velocities\n");
	fprintf(fid2,"    double qdd[NDOF],              // input: gen.accelerations\n");
