...
%> 
%> @details
%> This function creates walking simulation without an exoskeleton. If targetDuration
...
%> @param   Wtracking      Double: Weight used for tracking
...
% ======================================================================
function problem = walking2D_fixedsteprate(model, Wtracking, resultfile, trackingData, targetSpeed, targetDuration, isSymmetric, initialGuess)
